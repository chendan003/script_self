...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, required=False, default='DBSCAN', help='DBSCAN, API, AP, RankOrder')
    ...
    parser.add_argument('--saveResult', type=bool, required=False, default=True, help='Whether to save the result pics')
    ...
    parser.add_argument('--nProcess', type=int, required=False, default=16, help='Number of processes to read data')
