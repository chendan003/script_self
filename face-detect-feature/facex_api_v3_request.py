...
output_base_dir = './facex_api_response_wanrenli'
...
#    "secret_key": "gE_GKmqhbiC89Lyghtu6r5fU1_Xf0x_9dEMdCDl_",
#    "auth": "qiniu/mac"
#}
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        ...
        api_names = 'det+feat'
        # api_names = 'feat'
#        input_file = 'test_url_list_cluster.txt'
#        input_file = r"C:\zyf\00_Ataraxia\00-customer-test\bjrun_fp\list_img_bkt.txt"
       # input_file = r"C:\zyf\00_Ataraxia\00-customer-test\qingdao-tianyan\pics\list_img-bkt-10.txt"
#        input_file = '/workspace/data/blued_data/com_result_uri_list.txt' #url_list 
#        input_file = '/workspace/code/api_test/idcard_20/poli_url_list.txt'
